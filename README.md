...
ameliorations : register modification de profils, show h2 db, keyword issues, ajouter un css, templates en markdown, mise a jours repo, verification d'app, rapport, structure screen, security config screen
